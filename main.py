...
# Load images
img1_fn = 'images/nikhil.jpg' # copy idhr hogi
...
swap_face_single(img1_fn, img2_fn, app, swapper, enhance=False, enhancer='REAL-ESRGAN 2x', device="cuda")

# Fine face swapper
fine_face_swap(img1_fn, img2_fn, app, swapper, enhance=False, enhancer='REAL-ESRGAN 2x', device="cuda")
